...
% Change 'COM3' to individual port
...
numLayers = 10;     % Number of stepping layers
...
for layer = 0:(num_layers-1)
    ...
    endIdx = min(startIdx + points_per_layer - 1, size(data,1)); % Prevent index out of bounds
    idx = startIdx:endIdx;
...
axis equal;
grid on;
view(20, 15);  % You can tweak this to get exactly the view you want
